...
for root, dirs, song_files in os.walk("Testing/TestSongs/"):
    for filename in song_files:
        ...
        if(filename!=".DS_Store" and os.stat("Testing/TestSongs/"+filename).st_size>=80000):
            print("this is it! ",os.stat("Testing/TestSongs/"+filename).st_size)
            num = ""
...
for file in files:
    ...
    #parse file
    score = converter.parse(str(file), format='musicxml', forceSource=True)
