...
X, y, type2id = loader.load_data('Testing/iris.csv', y_label="species", x_labels=x_labels)
print("yyyyyy: ",y)
i = 0
...
svm_model_linear = SVC(kernel = 'poly',degree= 3).fit(X_train, y_train)
